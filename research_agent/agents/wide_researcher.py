"""Wide Researcher Agent — breadth-first paper discovery using kernel.sh + OpenAlex.

Spawns parallel browser sessions to crawl arxiv, OpenAlex, and Google Scholar.
